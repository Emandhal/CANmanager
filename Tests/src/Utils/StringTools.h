 ...
 * @param[in] value Is the value to convert
 * @param[in/out] *pBuffer Is the string where data will be saved (the original pointer will be advanced) and returns the new position in the string, or the end of the string
 * @param[in] charCount Is the count of char available in the destination string, it is also the buffer size
 */
 ...
 * @param[in] *pSrcBuffer Is the array of byte to convert
 * @param[in] srcSize Is the count of byte to convert in the source buffer
 * @param[out] *pDestStr Is the hexadecimal string where data will be saved
 * @param[in] destSize Is the count of char available in the destination string. If odd then the last char is discarded
 */
void Uint8Buffer_ToHexString(const uint8_t* pSrcBuffer, size_t srcSize, char* pDestStr, size_t destSize);
 ...
 * @param[in/out] **pStr Is the string to parse (the original pointer will be advanced) and returns the new position in the string, or the end of the string
 * @param[in] charCount Is the count of char to convert in the buffer into a 32-bit unsigned int
 * @return Returns the 32-bit unsigned int converted
 */
 ...
 *
 * Extract each bytes from the pSrcStr and save them in the destBuffer. If the string terminate before the end of buffer then the function terminate
 * @param[in] *pSrcStr Is the hexadecimal string to convert
 * @param[out] *pDestBuffer Is the byte array where data will be saved
 * @param[in] destSize Is the count of byte available in the destination buffer
